...
# Streamlit UI for Hill Cipher - Chosen Ciphertext Attack (Supports 2x2 and 3x3)
...
default_plain_text = "ACTG" if matrix_size == 2 else "HELPQUICK"
default_cipher_text = "PQMI" if matrix_size == 2 else "RSQPBFPVI"
plain_text_input = st.text_input("Enter a Known Plaintext:", value=default_plain_text)
cipher_text_input = st.text_input("Enter the Corresponding Ciphertext:", value=default_cipher_text)
